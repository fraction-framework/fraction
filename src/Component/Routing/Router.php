...
class Router {
  ...
  public function __construct(private readonly RoutingProvider $provider, private readonly Trie $routes, private readonly ConfigManager $configManager, private readonly Reader $reader) {
  }
